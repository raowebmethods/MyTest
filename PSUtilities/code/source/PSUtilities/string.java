...
// -----( CREATED: 2005-04-04 16:29:06 PDT
// -----( ON-HOST: 10.3.16.33
...

{
  ...
  public static final void convertLineSeparator(IData pipeline) throws ServiceException
  {
  ...
  public static final void isAlphanumeric(IData pipeline) throws ServiceException
  {
  ...
  public static final void isDate(IData pipeline) throws ServiceException
  {
    // --- <<IS-START(isDate)>> ---
    // @sigtype java 3.5
    // [i] field:0:required input
  ...
  public static final void isNumeric(IData pipeline) throws ServiceException
  {
    // --- <<IS-START(isNumeric)>> ---
    // @sigtype java 3.5
    // [i] field:0:required input
  ...
  public static final void removeLineSeparators(IData pipeline) throws ServiceException
  {
  ...
  public static final void substringRT(IData pipeline) throws ServiceException
  {
